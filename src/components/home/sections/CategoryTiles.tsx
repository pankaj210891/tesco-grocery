...
function CategoryTile({ item }: { item: SectionItem }) {
  return (
    <Link
      href={item.href}
      className="flex items-center gap-3 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-[#FCA311]/30 hover:shadow-md transition-colors transition-shadow duration-150 group"
