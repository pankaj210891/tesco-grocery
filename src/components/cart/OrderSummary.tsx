...
export default function OrderSummary({ subtotal }: OrderSummaryProps) {
  ...
  return (
    <div
      ...
      className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-5 sm:p-6 space-y-5 sticky top-28"
    >
      ...
      <div className="space-y-1.5">
        ...
        <div className="h-1.5 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
          <div
            className="h-full bg-[#FCA311] rounded-full transition-[width] duration-700"
      ...
      <Link
        href="/checkout"
        className="block w-full text-center py-3.5 rounded-xl font-bold text-base bg-[#FCA311] text-white hover:bg-[#E8920A] transition-colors transition-transform active:scale-[0.98] shadow-sm"
      >
        Proceed to Checkout →
      </Link>
      <Link
