...
/**
 * Return an array of 4 local WebP image paths for a given product.
 * Files are generated by `node scripts/generate-images.mjs`.
 */
export function productImages(name: string): string[] {
  const slug = toSlug(name);
  return [
    `/images/products/${slug}/main.webp`,
    `/images/products/${slug}/side.webp`,
    `/images/products/${slug}/lifestyle.webp`,
    `/images/products/${slug}/closeup.webp`,
  ];
}
