...
async function seedOffers(): Promise<{ inserted: number; deleted: number }> {
  ...
  const OFFERS = [
    { title: "Weekend Mega Sale",              subtitle: "Up to 30% off fresh food",           description: "Massive savings across our fresh food range every weekend.",              code: "WEEKEND30",   discountType: "percentage", discountValue: 30,  minOrderValue: 0,  expiresAt: days(3),   badge: "HOT",      color: "#FFF3E0", emoji: "🥦", category: "fresh-food",   href: "/categories/fresh-food",   order: 1, isActive: true },
    { title: "Free Delivery Over £50",         subtitle: "Shop more, save on delivery",         description: "Enjoy free next-day delivery on all orders over £50.",                   discountType: "freeDelivery", discountValue: 0, minOrderValue: 50, expiresAt: days(30),  badge: "FREE",     color: "#E8F5E9", emoji: "🚚", category: "all",          href: "/products",                order: 2, isActive: true },
    { title: "Bakery Fresh Every Morning",     subtitle: "20% off all bakery items",            description: "Freshly baked discounts before 10am. Use code online.",                  code: "FRESHBAKE20", discountType: "percentage", discountValue: 20,  minOrderValue: 0,  expiresAt: days(14),  badge: "NEW",      color: "#FFF8E1", emoji: "🥐", category: "bakery",        href: "/categories/bakery",       order: 3, isActive: true },
    { title: "£10 Off Your First Order",       subtitle: "New customer exclusive",              description: "Welcome to Prakash! Enjoy £10 off when you spend £30+.",                 code: "WELCOME10",   discountType: "fixed",      discountValue: 10,  minOrderValue: 30, expiresAt: days(60),  badge: "NEW",      color: "#E3F2FD", emoji: "🎉", category: "all",          href: "/products",                order: 4, isActive: true },
    { title: "Drinks Bonanza",                 subtitle: "Buy 2 get 1 free on selected drinks", description: "Stock up your fridge with our buy-2-get-1-free on soft drinks.",          code: "DRINKS3FOR2", discountType: "percentage", discountValue: 33,  minOrderValue: 0,  expiresAt: days(7),   badge: "3 FOR 2",  color: "#E1F5FE", emoji: "🥤", category: "drinks",        href: "/categories/drinks",       order: 5, isActive: true },
    { title: "Frozen Food Fiesta",             subtitle: "Save 25% across frozen range",        description: "25% off our entire frozen range. Convenient and delicious.",              code: "FROZEN25",    discountType: "percentage", discountValue: 25,  minOrderValue: 20, expiresAt: days(10),  badge: "SALE",     color: "#E0F7FA", emoji: "❄️", category: "frozen-food",   href: "/categories/frozen-food",  order: 6, isActive: true },
    { title: "Health & Beauty Event",          subtitle: "15% off premium brands",              description: "Treat yourself with 15% off across Health & Beauty.",                    code: "BEAUTY15",    discountType: "percentage", discountValue: 15,  minOrderValue: 15, expiresAt: days(21),  badge: "EVENT",    color: "#FCE4EC", emoji: "💄", category: "health-beauty", href: "/categories/health-beauty",order: 7, isActive: true },
    { title: "PRAKASH10 — Always On",          subtitle: "10% off any order, any time",         description: "Our signature code. 10% off any order. Never expires.",                  code: "PRAKASH10",   discountType: "percentage", discountValue: 10,  minOrderValue: 0,  expiresAt: days(365), badge: "ALWAYS ON",color: "#EDE7F6", emoji: "🏷️",category: "all",          href: "/products",                order: 8, isActive: true },
    { title: "Student Discount 20%",           subtitle: "Exclusive student deal",              description: "20% off for verified students. Use code at checkout.",                    code: "STUDENT20",   discountType: "percentage", discountValue: 20,  minOrderValue: 20, expiresAt: days(90),  badge: "STUDENT",  color: "#E8EAF6", emoji: "🎓", category: "all",          href: "/products",                order: 9, isActive: true },
    { title: "Snacks Happy Hour",              subtitle: "25% off treats & snacks",             description: "Grab your favourites at 25% off every Thursday evening.",                 code: "SNACKHOUR",   discountType: "percentage", discountValue: 25,  minOrderValue: 10, expiresAt: days(5),   badge: "HAPPY HOUR",color:"#FFF9C4",emoji: "🍿", category: "treats-snacks", href: "/categories/treats-snacks",order: 10,isActive: true },
    { title: "Organic Week",                   subtitle: "15% off all organic products",        description: "Celebrate organic week with 15% off all ORGANIC-badged items.",           code: "ORGANIC15",   discountType: "percentage", discountValue: 15,  minOrderValue: 0,  expiresAt: days(7),   badge: "ORGANIC",  color: "#F1F8E9", emoji: "🌿", category: "fresh-food",   href: "/categories/fresh-food",   order: 11,isActive: true },
    { title: "Tech Tuesday",                   subtitle: "£10 off electronics orders",          description: "Every Tuesday, £10 off any electronics & gaming order over £50.",         code: "TECHTUESDAY", discountType: "fixed",      discountValue: 10,  minOrderValue: 50, expiresAt: days(8),   badge: "WEEKLY",   color: "#E3F2FD", emoji: "🎮", category: "electronics-gaming",href:"/categories/electronics-gaming",order:12,isActive:true},
    { title: "Pet Pampering Weekend",          subtitle: "20% off pet food and accessories",    description: "Spoil your furry friends with 20% off our entire pets range.",             code: "PETS20",      discountType: "percentage", discountValue: 20,  minOrderValue: 15, expiresAt: days(4),   badge: "PETS",     color: "#F9FBE7", emoji: "🐾", category: "pets",          href: "/categories/pets",         order: 13,isActive: true },
    { title: "Buy 2 Bakery Items Save £1",     subtitle: "Great bakery bundle deal",            description: "Add any 2 bakery items to your basket and save £1 automatically.",        code: "BAKE2SAVE",   discountType: "fixed",      discountValue: 1,   minOrderValue: 5,  expiresAt: days(14),  badge: "BUNDLE",   color: "#FFFDE7", emoji: "🧁", category: "bakery",        href: "/categories/bakery",       order: 14,isActive: true },
    { title: "Summer Drinks Bundle 30%",       subtitle: "Cool down and save",                  description: "30% off selected summer drinks — juices, water, and soft drinks.",        code: "SUMMERDRINK", discountType: "percentage", discountValue: 30,  minOrderValue: 25, expiresAt: days(20),  badge: "SUMMER",   color: "#E0F2F1", emoji: "☀️", category: "drinks",        href: "/categories/drinks",       order: 15,isActive: true },
  ];
