...
async function seedOffers(): Promise<{ inserted: number; deleted: number }> {
  ...
  const OFFERS = [
    ...
    { title: "Free Delivery Over ₹999",     subtitle: "Shop more, save on delivery",         description: "Enjoy free next-day delivery on all orders over ₹999. No code needed — applied automatically at checkout.",       discountType: "freeDelivery", discountValue: 0, minOrderValue: 999,  expiresAt: days(30),  badge: "FREE",      color: "#E8F5E9", emoji: "🚚", category: "all",               href: "/products",                     order: 2,  isActive: true, eligibleCategories: [],                     eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
    ...
    { title: "₹799 Off Your First Order",  subtitle: "New customer exclusive",              description: "Welcome to Prakash! Enjoy ₹799 off your first online order when you spend ₹1,499 or more.", code: "WELCOME10",   discountType: "fixed",      discountValue: 799, minOrderValue: 1499, expiresAt: days(60),  badge: "NEW",       color: "#E3F2FD", emoji: "🎉", category: "all",               href: "/products",                     order: 4,  isActive: true, eligibleCategories: [],                     eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: 1,    firstOrderOnly: true,  usedCount: 0 },
    ...
    { title: "Frozen Food Fiesta",         subtitle: "Save 25% across frozen range",        description: "25% off our entire frozen range. Convenient and delicious.",      code: "FROZEN25",    discountType: "percentage", discountValue: 25, minOrderValue: 499,  expiresAt: days(10),  badge: "SALE",      color: "#E0F7FA", emoji: "❄️", category: "frozen-food",       href: "/categories/frozen-food",       order: 6,  isActive: true, eligibleCategories: ["frozen-food"],        eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
    { title: "Health & Beauty Event",      subtitle: "15% off premium brands",              description: "Treat yourself with 15% off across Health & Beauty.",             code: "BEAUTY15",    discountType: "percentage", discountValue: 15, minOrderValue: 299,  expiresAt: days(21),  badge: "EVENT",     color: "#FCE4EC", emoji: "💄", category: "health-beauty",     href: "/categories/health-beauty",     order: 7,  isActive: true, eligibleCategories: ["health-beauty"],      eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
    ...
    { title: "Tech Tuesday",               subtitle: "₹799 off electronics orders",         description: "Every Tuesday, ₹799 off any electronics & gaming order over ₹4,999.", code: "TECHTUESDAY", discountType: "fixed",  discountValue: 799, minOrderValue: 4999, expiresAt: days(8),   badge: "WEEKLY",    color: "#E3F2FD", emoji: "🎮", category: "electronics-gaming", href: "/categories/electronics-gaming", order: 12, isActive: true, eligibleCategories: ["electronics-gaming"], eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
    { title: "Pet Pampering Weekend",      subtitle: "20% off pet food and accessories",    description: "Spoil your furry friends with 20% off our entire pets range.",    code: "PETS20",      discountType: "percentage", discountValue: 20, minOrderValue: 249,  expiresAt: days(4),   badge: "PETS",      color: "#F9FBE7", emoji: "🐾", category: "pets",              href: "/categories/pets",              order: 13, isActive: true, eligibleCategories: ["pets"],               eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
    { title: "Buy 2 Bakery Items Save ₹99",subtitle: "Great bakery bundle deal",            description: "Add any 2 bakery items to your basket and save ₹99.",            code: "BAKE2SAVE",   discountType: "fixed",      discountValue: 99,  minOrderValue: 99,   expiresAt: days(14),  badge: "BUNDLE",    color: "#FFFDE7", emoji: "🧁", category: "bakery",            href: "/categories/bakery",            order: 14, isActive: true, eligibleCategories: ["bakery"],             eligibleProductIds: [], eligiblePincodes: [], usageLimit: null, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
    { title: "Summer Drinks Bundle 30%",   subtitle: "Cool down and save",                  description: "30% off selected summer drinks — juices, water, and soft drinks.",code: "SUMMERDRINK", discountType: "percentage", discountValue: 30, minOrderValue: 399,  expiresAt: days(20),  badge: "SUMMER",    color: "#E0F2F1", emoji: "☀️", category: "drinks",            href: "/categories/drinks",            order: 15, isActive: true, eligibleCategories: ["drinks"],             eligibleProductIds: [], eligiblePincodes: ["HA","UB","W","TW"], usageLimit: 500, perUserLimit: null, firstOrderOnly: false, usedCount: 0 },
  ];
...
async function seedFaqs(): Promise<{ inserted: number; deleted: number }> {
  const FAQS = [
    { question:"What are your delivery options?",               answer:"We offer next-day delivery (free over ₹500, otherwise ₹49) and Click & Collect from any of our seven stores, usually within 2 hours.",                                               category:"delivery", order:1,  isActive:true },
    ...
    { question:"How do I earn and redeem loyalty points?",      answer:"You earn 1 point for every ₹100 spent. Points appear in your account within 24 hours of delivery and can be redeemed at checkout (100 points = ₹100 off).",                             category:"account",  order:15, isActive:true },
  ];
...
async function seedHomepage(): Promise<{ inserted: number; deleted: number }> {
  ...
  const SECTIONS = [
    { key:"hero-banner",    title:"Hero Banner",                               type:"hero-banner",        order:0, isActive:true, items:[
      ...
      { title:"Free Delivery Over ₹500",         subtitle:"Fill your basket and we'll bring it straight to you, free of charge.",            badge:"Start Shopping",          href:"/products",                              color:"from-[#1B5E20] to-[#0A2E0D]",   emoji:"🚚", order:3 },
    ...
    { key:"whats-new",     title:"What's new this week?",                    subtitle:"Fresh arrivals and seasonal picks, updated every week",                    type:"product-carousel",   order:1, isActive:true, ctaLabel:"Shop all new",      ctaHref:"/products?sortBy=newest", items:[{title:"Organic Whole Milk 2L",brand:"Prakash Organic",price:190,emoji:"🥛",color:"#EFF6FF",badge:"New", href:"/products/organic-whole-milk-2l",productSlug:"organic-whole-milk-2l",order:1},{title:"Sourdough Bloomer Loaf",brand:"Golden Crust",price:264,emoji:"🍞",color:"#FFFBEB",badge:"New",href:"/products/sourdough-bloomer-loaf-800g",productSlug:"sourdough-bloomer-loaf-800g",order:2},{title:"Sparkling Elderflower",brand:"Fentimans",price:169,emoji:"🌸",color:"#FDF4FF",badge:"New",href:"/categories/drinks",order:3},{title:"Mixed Berry Granola",brand:"Prakash Finest",price:370,emoji:"🫐",color:"#F0FDF4",badge:"New",href:"/categories/food-cupboard",order:4},{title:"Smoked Scottish Salmon",brand:"Scottish Select",price:529,emoji:"🐟",color:"#FFF1F2",badge:"New",href:"/products/scottish-salmon-fillet-240g",productSlug:"scottish-salmon-fillet-240g",order:5},{title:"Dark Chocolate 85%",brand:"Lindt",price:243,emoji:"🍫",color:"#FEF3C7",badge:"New",href:"/categories/treats-snacks",order:6},{title:"Greek Style Yoghurt",brand:"Chobani",price:296,emoji:"🍶",color:"#F0F9FF",badge:"New",href:"/products/greek-style-yogurt-500g",productSlug:"greek-style-yogurt-500g",order:7},{title:"Avocado Dip Guacamole",brand:"Wholly Guacamole",price:264,emoji:"🥑",color:"#F0FDF4",badge:"New",href:"/products/ripe-avocados-2pk",productSlug:"ripe-avocados-2pk",order:8}]},
    { key:"top-picks",     title:"Top picks for you this week",               subtitle:"Handpicked by our team just for you",                                      type:"product-carousel",   order:2, isActive:true, ctaLabel:"See all picks",     ctaHref:"/products?sortBy=rating", items:[{title:"Mature Cheddar 400g",brand:"Cathedral City",price:345,emoji:"🧀",color:"#FEF3C7",badge:"Popular",href:"/products/mature-cheddar-cheese-400g",productSlug:"mature-cheddar-cheese-400g",order:1},{title:"Free Range Eggs 6pk",brand:"Happy Hens",price:200,emoji:"🥚",color:"#FFFBEB",badge:"Popular",href:"/products/free-range-large-eggs-6pk",productSlug:"free-range-large-eggs-6pk",order:2},{title:"Chicken Breast Fillets",brand:"Prakash Finest",price:398,emoji:"🍗",color:"#FFF7ED",badge:"Popular",href:"/products/british-chicken-breast-fillets",productSlug:"british-chicken-breast-fillets",order:3},{title:"Tilda Basmati Rice 2kg",brand:"Tilda",price:477,emoji:"🍚",color:"#F9FAFB",badge:"Popular",href:"/products/tilda-basmati-rice-2kg",productSlug:"tilda-basmati-rice-2kg",order:4},{title:"Extra Virgin Olive Oil",brand:"Filippo Berio",price:610,emoji:"🫒",color:"#F0FDF4",badge:"Popular",href:"/products/extra-virgin-olive-oil-500ml",productSlug:"extra-virgin-olive-oil-500ml",order:5},{title:"Barilla Penne Pasta",brand:"Barilla",price:133,emoji:"🍝",color:"#FFFBEB",badge:"Popular",href:"/products/barilla-penne-pasta-500g",productSlug:"barilla-penne-pasta-500g",order:6},{title:"Buxton Still Water 12pk",brand:"Buxton",price:423,emoji:"💧",color:"#EFF6FF",badge:"Popular",href:"/products/buxton-still-water-12pk-500ml",productSlug:"buxton-still-water-12pk-500ml",order:7},{title:"Butter Croissants 4pk",brand:"Golden Crust",price:186,emoji:"🥐",color:"#FEF9C3",badge:"Popular",href:"/products/butter-croissants-4pk",productSlug:"butter-croissants-4pk",order:8}]},
    { key:"popular-offers", title:"Popular offers ending soon",               subtitle:"Grab these deals before they're gone",                                    type:"offer-cards",        order:3, isActive:true, ctaLabel:"Shop all products",  ctaHref:"/products?sortBy=price-asc", items:[{title:"Heinz Baked Beans 4pk",brand:"Heinz",price:212,originalPrice:306,discount:31,emoji:"🫘",color:"#FFF0F3",badge:"31% off",expiresAt:days(2),href:"/products/heinz-baked-beans-4pk-415g",productSlug:"heinz-baked-beans-4pk-415g",order:1},{title:"Tropicana Orange Juice",brand:"Tropicana",price:264,originalPrice:317,discount:17,emoji:"🍊",color:"#FFF7ED",badge:"17% off",expiresAt:days(3),href:"/products/tropicana-orange-juice-1l",productSlug:"tropicana-orange-juice-1l",order:2},{title:"Heinz Tomato Ketchup",brand:"Heinz",price:239,originalPrice:296,discount:19,emoji:"🍅",color:"#FFF1F2",badge:"19% off",expiresAt:days(1),href:"/products/heinz-tomato-ketchup-570g",productSlug:"heinz-tomato-ketchup-570g",order:3},{title:"Kellogg's Cornflakes",brand:"Kellogg's",price:264,originalPrice:370,discount:29,emoji:"🌾",color:"#FFFBEB",badge:"29% off",expiresAt:days(4),href:"/products/kelloggs-cornflakes-500g",productSlug:"kelloggs-cornflakes-500g",order:4},{title:"McVitie's Digestives",brand:"McVitie's",price:133,originalPrice:200,discount:34,emoji:"🍪",color:"#FEF9C3",badge:"34% off",expiresAt:days(2),href:"/products/digestive-biscuits-400g",productSlug:"digestive-biscuits-400g",order:5},{title:"Arla Whole Milk 4pt",brand:"Arla",price:138,originalPrice:175,discount:21,emoji:"🥛",color:"#EFF6FF",badge:"21% off",expiresAt:days(5),href:"/categories/fresh-food",order:6},{title:"Walkers Crisps 6pk",brand:"Walkers",price:212,originalPrice:296,discount:28,emoji:"🥔",color:"#FEF3C7",badge:"28% off",expiresAt:days(3),href:"/products/ready-salted-crisps-multipack",productSlug:"ready-salted-crisps-multipack",order:7},{title:"Coca-Cola 6pk Cans",brand:"Coca-Cola",price:423,originalPrice:529,discount:20,emoji:"🥤",color:"#FFF0F3",badge:"20% off",expiresAt:days(2),href:"/products/coca-cola-original-6pk-cans",productSlug:"coca-cola-original-6pk-cans",order:8}]},
    ...
    { key:"trending",      title:"Trending now",                               subtitle:"What everyone is adding to their baskets this week",                      type:"product-carousel",   order:5, isActive:true, ctaLabel:"See all trending",  ctaHref:"/products?sortBy=rating", items:[{title:"GT's Kombucha Ginger Lemon",brand:"GT's",price:317,emoji:"🍵",color:"#F0FDF4",badge:"🔥 Hot",href:"/products/gts-kombucha-ginger-lemon-330ml",productSlug:"gts-kombucha-ginger-lemon-330ml",order:1},{title:"Quaker Porridge Oats 1kg",brand:"Quaker",price:239,emoji:"🥣",color:"#FFFBEB",badge:"🔥 Hot",href:"/products/quaker-oat-so-simple-oats-1kg",productSlug:"quaker-oat-so-simple-oats-1kg",order:2},{title:"Oatly Barista Oat Drink",brand:"Oatly",price:239,emoji:"🌾",color:"#FEF9C3",badge:"🔥 Hot",href:"/products/oatly-barista-oat-drink-1l",productSlug:"oatly-barista-oat-drink-1l",order:3},{title:"Meridian Peanut Butter",brand:"Meridian",price:370,emoji:"🥜",color:"#FEF3C7",badge:"🔥 Hot",href:"/products/meridian-smooth-peanut-butter",productSlug:"meridian-smooth-peanut-butter",order:4},{title:"Clipper Organic Green Tea",brand:"Clipper",price:264,emoji:"🍵",color:"#F0FDF4",badge:"🔥 Hot",href:"/products/clipper-organic-green-tea-20pk",productSlug:"clipper-organic-green-tea-20pk",order:5},{title:"Red Lentils 500g",brand:"Prakash",price:106,emoji:"🌱",color:"#F0F9FF",badge:"🔥 Hot",href:"/products/red-lentils-500g",productSlug:"red-lentils-500g",order:6},{title:"Vita Coco Coconut Water",brand:"Vita Coco",price:264,emoji:"🥥",color:"#F0FDF4",badge:"🔥 Hot",href:"/products/vita-coco-coconut-water-1l",productSlug:"vita-coco-coconut-water-1l",order:7},{title:"Quorn Mince 500g",brand:"Quorn",price:345,emoji:"🌿",color:"#F0FDF4",badge:"🔥 Hot",href:"/products/quorn-mince-500g",productSlug:"quorn-mince-500g",order:8}]},
    { key:"ways-to-shop",  title:"Ways to shop and save",                      subtitle:"Making great value shopping easier for everyone",                         type:"info-cards",         order:6, isActive:true, items:[{title:"Free Next-Day Delivery",description:"Free on all orders over ₹500. Fast, reliable, tracked.",emoji:"🚚",color:"#EFF6FF",href:"/faq",order:1},{title:"Click & Collect",description:"Order online and pick up from your nearest store.",emoji:"🏪",color:"#F0FDF4",href:"/store-locator",order:2},{title:"Price Match Promise",description:"Find it cheaper elsewhere? We'll match the price.",emoji:"🏷️",color:"#FFF7ED",href:"/faq",order:3},{title:"Loyalty Points",description:"Earn 1 point per ₹100 spent — redeem on any order.",emoji:"⭐",color:"#FEFCE8",href:"/account",order:4},{title:"Student Discount",description:"Exclusive 20% off sitewide — verify your status.",emoji:"🎓",color:"#FDF4FF",href:"/faq",order:5},{title:"Subscribe & Save",description:"Set up auto-delivery and save 15% on every order.",emoji:"♻️",color:"#F0F9FF",href:"/products",order:6}]},
    { key:"discover-more", title:"Discover more from Prakash",                 subtitle:"Collections and ranges curated just for you",                             type:"category-tiles",     order:7, isActive:true, items:[{title:"Meal Deals",subtitle:"Lunch sorted from ₹99",emoji:"🥪",color:"#EFF6FF",href:"/categories/food-cupboard",order:1},{title:"Healthy Living",subtitle:"Nutritious and delicious picks",emoji:"🥗",color:"#F0FDF4",href:"/categories/fresh-food",order:2},{title:"World Cuisine",subtitle:"Flavours from around the globe",emoji:"🌍",color:"#FFF7ED",href:"/categories/food-cupboard",order:3},{title:"Plant-Based",subtitle:"Vegan & vegetarian favourites",emoji:"🌱",color:"#F0FDF4",href:"/categories/fresh-food",order:4},{title:"Family Favourites",subtitle:"Everyone will love these",emoji:"👨‍👩‍👧",color:"#FDF4FF",href:"/categories/treats-snacks",order:5},{title:"Student Essentials",subtitle:"Budget-friendly basics",emoji:"📚",color:"#FEFCE8",href:"/categories/food-cupboard",order:6},{title:"British Classics",subtitle:"Homegrown and handpicked",emoji:"🇬🇧",color:"#FFF1F2",href:"/categories/food-cupboard",order:7},{title:"Summer BBQ",subtitle:"Fire up the grill",emoji:"🔥",color:"#FFF7ED",href:"/categories/fresh-food",order:8}]},
    ...
    { key:"explore-more",  title:"Even more to explore",                       subtitle:"There's always something new to discover at Prakash",                     type:"explore-cards",      order:9, isActive:true, items:[{title:"Summer BBQ Essentials",subtitle:"Everything for the perfect cookout",emoji:"🍖",color:"#FFF7ED",href:"/categories/fresh-food",order:1},{title:"New Season Arrivals",subtitle:"Just landed in store this week",emoji:"✨",color:"#F0F9FF",href:"/products?sortBy=newest",order:2},{title:"Budget Buys Under ₹99",subtitle:"Great quality at an unbeatable price",emoji:"💰",color:"#F0FDF4",href:"/offers",order:3},{title:"Recipe Kits",subtitle:"Cook like a pro in 30 minutes",emoji:"👨‍🍳",color:"#FDF4FF",href:"/categories/food-cupboard",order:4},{title:"Organic Range",subtitle:"Better for you and the planet",emoji:"🌿",color:"#F0FDF4",href:"/categories/fresh-food",order:5},{title:"Kids' Lunchbox Picks",subtitle:"Healthy and fun for little ones",emoji:"🎒",color:"#FFF1F2",href:"/categories/treats-snacks",order:6}]},
  ];
