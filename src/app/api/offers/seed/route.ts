...
const OFFERS = [
  ...
  {
    title:         "Free Delivery on Orders Over ₹999",
    subtitle:      "Shop more, save on delivery",
    description:   "Enjoy free next-day delivery on all orders over ₹999. No promo code needed — the discount is applied automatically at checkout.",
  ...
  {
    title:         "₹799 Off Your First Order",
    subtitle:      "New customer exclusive",
    description:   "Welcome to Prakash Supermarket! Enjoy ₹799 off your first online order when you spend ₹1,499 or more. One use per customer.",
    code:          "WELCOME10",
    discountType:  "fixed",
    discountValue: 799,
    minOrderValue: 1499,
