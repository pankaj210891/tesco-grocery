    ...
    Promise.allSettled([
      ...
      .then(([statsResult, profileResult, analyticsResult]) => {
        if (statsResult.status === "fulfilled")
          setStats(statsResult.value.data.data as VendorStats);
        if (profileResult.status === "fulfilled")
          setProfile(profileResult.value.data.data as Vendor);
        if (analyticsResult.status === "fulfilled")
          setAnalytics(analyticsResult.value.data.data as VendorAnalytics);
      })
      ...
      {stats && (
        ...
        >
          ...
          <StatsCard
            ...
            icon={CheckCircle}
            color="green"
            href="/vendor/products?inStock=true"
          />
          <StatsCard
            label="Out of Stock"
      ...
      {analytics && (
        <div className="flex items-center justify-between mb-0">
          ...
          <Link
            ...
            className="flex items-center gap-1 text-xs text-[#FCA311] hover:text-[#E8920A] font-semibold transition-colors"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 p-5">
            ...
            <p
              ...
              data-testid="vendor-total-revenue"
            >
              ₹
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 p-5">
            ...
            <p
              className="text-2xl font-black text-gray-900 dark:text-gray-100"
              data-testid="vendor-total-orders"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5 leading-relaxed">
                Add, edit, or remove your products and manage stock levels
              </p>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5 leading-relaxed">
                View and update shipment status for your orders
              </p>
              {stats && stats.pendingOrders > 0 && (
                <p className="flex items-center gap-1 text-xs text-yellow-600 font-medium mt-1.5">
                  <AlertTriangle className="h-3 w-3" /> {stats.pendingOrders}{" "}
                  pending
                </p>
              )}
            </div>
