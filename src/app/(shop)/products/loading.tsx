      ...
      <div className="flex gap-6">
          ...
          <div className="space-y-5 animate-pulse">
            ...
            <div className="border-t border-gray-100 dark:border-gray-700 pt-4 space-y-2">
              ...
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="h-4 bg-gray-100 dark:bg-gray-700 rounded w-3/4" />
              ))}
            </div>
          </div>
        </aside>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mb-5 animate-pulse">
            <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded-lg w-24 lg:hidden" />
            <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded-lg w-40" />
            <div className="ml-auto h-4 bg-gray-200 dark:bg-gray-700 rounded w-20 hidden sm:block" />
          </div>
