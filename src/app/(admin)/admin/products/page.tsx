...
const EMPTY_FORM = { name:"", slug:"", description:"", price:"", originalPrice:"", category:"", brand:"", unit:"", images:"", tags:"", badge:"" as ProductBadge | "", inStock: true };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <button onClick={openAdd} className="flex items-center gap-2 px-4 py-2 bg-[#0F4C75] text-white text-sm font-semibold rounded-lg hover:bg-[#0A3352] transition-colors">
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
              {loading ? (
                ...
                <tr key={p._id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/30">
                  ...
                  <td className="px-4 py-3">
                    <span className="font-bold text-gray-900 dark:text-gray-100">£{p.price.toFixed(2)}</span>
                    {p.originalPrice && <span className="ml-1 text-xs text-gray-400 line-through">£{p.originalPrice.toFixed(2)}</span>}
                  </td>
                  <td className="px-4 py-3">
                    {p.badge ? (
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button onClick={() => openEdit(p)} className="p-1.5 rounded-lg text-gray-400 hover:text-[#0F4C75] hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors">
                        <Pencil className="h-4 w-4" />
                      </button>
                      <button onClick={() => handleDelete(p._id)} className="p-1.5 rounded-lg text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setForm((f) => ({
                          ...f,
                          [field]: val,
                          ...(field === "name" && !editing ? { slug: slugify(val) } : {}),
                        }));
                      }}
